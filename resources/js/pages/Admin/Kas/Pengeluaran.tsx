...
import { ArrowLeft, Plus, Calendar, DollarSign, FileText, Trash2 } from "lucide-react"
...
export default function Pengeluaran() {
  const { pengeluaran } = usePage<PageProps>().props
  ...
  const totalPengeluaran = pengeluaran.reduce((total, item) => total + item.nominal, 0)
      ...
      <div className="w-full p-4 md:p-6 space-y-6">
        ...
        <div>
          <div className="flex items-center gap-3 mb-2">
            ...
            <h1 className="text-2xl font-bold text-gray-800">Tambah Pengeluaran Kas</h1>
          </div>
          <p className="text-gray-600">Tambahkan data pengeluaran kas ke dalam sistem management iuran warga</p>
        </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <Input
                      ...
                      placeholder="Masukkan keperluan pengeluaran"
                      className="w-full pl-10"
                      required
                    />
                  </div>
        ...
        <Card className="w-full shadow-lg border-0">
          <CardHeader className="bg-gradient-to-r from-red-50 to-orange-50">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
              <div>
                <CardTitle>Daftar Pengeluaran Kas</CardTitle>
                <CardDescription>
                  {pengeluaran.length} data pengeluaran kas ditemukan
                </CardDescription>
              </div>
              <div className="mt-2 sm:mt-0">
                <Badge variant="secondary" className="bg-red-100 text-red-800 text-sm py-1">
              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b">
                    ...
                    <th className="text-left py-3 px-4 font-medium">Keperluan</th>
                    ...
                    pengeluaran.map((item) => (
                      <tr key={item.id} className="border-b">
                        ...
                        <td className="py-3 px-4 text-center">
                          <Link
                            href={`/admin/kas/pengeluaran/${item.id}`}
                            method="delete"
                            as="button"
                    ...
                    <tr>
                      <td colSpan={5} className="text-center py-8 text-gray-500">
                        <div className="flex flex-col items-center justify-center">
                          ...
                          <p className="text-sm">Tambahkan data pengeluaran menggunakan form di atas</p>
                        </div>
                      </td>
                    </tr>
                  )}
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-blue-700">
                Pastikan data yang dimasukkan sudah benar. Pengeluaran yang sudah disimpan
