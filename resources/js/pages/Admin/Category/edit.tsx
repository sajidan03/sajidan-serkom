...
export default function CategoryEdit({ category }: CategoryEditProps) {
  const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: "Edit", href: `/admin/category/edit/${category.id}` },
  ]
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault()
    put(`/admin/category/update/${category.id}`)
  }

  return (
    <AppLayout breadcrumbs={breadcrumbs}>
      <Head title="Edit Jenis Iuran" />
      ...
      <div className="w-full px-4 md:px-10 space-y-6">
        <div>
          ...
          <p className="text-gray-500 text-sm">
            Perbarui informasi jenis iuran berikut.
          </p>
        </div>
