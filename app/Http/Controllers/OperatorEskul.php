...
class OperatorEskul extends Controller
{
    //
   public function index()
{
    ...
    $eskul = Ekstrakulikuler::with('guru')->get();
    ...
    return Inertia::render('Operator/Ekstrakulikuler/index', $data);
}    public function ekskulTambahView()
    {
        $data['guru'] = Guru::all();
        $data['profil'] = Profil_sekolah::all()->first();
        return Inertia::render('Operator/Ekstrakulikuler/tambah',$data);
    }
 ...
 public function ekskulEditView($id)
{
    ...
    return Inertia::render('Operator/Ekstrakulikuler/edit', $data);
}
